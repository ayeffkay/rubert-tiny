...
python -m torch.distributed.launch \
    ...
    train.py \
    --force \
    --dump_path distilrubert-tiny-contrastive-v0-match-kl-mlm-neg_s-avg-all-dump \
    --tensorboard_logs_path tensorboard_logs_rubert_tiny_updated \
    --tensorboard_log_name distilrubert-tiny-contrastive-v0-match-kl-mlm-neg_s-avg-all \
    ...
    --align_hiddens None --n_negative_samples -1 \
